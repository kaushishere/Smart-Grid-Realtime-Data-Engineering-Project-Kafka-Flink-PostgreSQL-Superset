...
public class DataStreamJob {
	...
	public static void main(String[] args) throws Exception {
        ...
        WatermarkStrategy<Reading> watermarkStrategy= WatermarkStrategy
         ...
         // half-hourly averages (e.g. wind power, solar power) (EFFICIENT WAY)
        DataStream<HalfHourAverages> avgs = readingStream
        ...
        // HalfHourAverages (window_start, avg_wind, avg_solar)
        // HalfHourAverages (2025-12-20T12:30:00, 96.8, 103.2)

        String sql = "INSERT INTO halfhourlyaverages (window_start, avg_wind, avg_solar) " +
                "VALUES (?, ?, ?) " +
                "ON CONFLICT (window_start) DO UPDATE SET " +
                "avg_wind = EXCLUDED.avg_wind, " +
                "avg_solar = EXCLUDED.avg_solar";

        // OLD ONE: "insert into halfhourlyaverages (window_start, avg_wind, avg_solar) values (?, ?, ?)"
